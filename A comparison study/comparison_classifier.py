#%%
'''
This practice is adopted from one of the kaggle competition over Quera question pairs.
The aim here is to extract some usefull and interperatble features using fuzzywuzzy.fuzz and then 
apply some of the wellknow classifier and compare theri result
link to source: https://www.kaggle.com/aneeshc/fuzzy-feature-based-classification?select=train.csv.zip
'''
